  ...
  return (
    <>
      <article className="bg-white p-5 rounded-lg shadow hover:-translate-y-1 transition-transform">
        <img src={imgCBM} alt="Course 1" className="w-full h-48 object-cover rounded" />
        <h3 className="font-semibold text-lg my-3">Big 4 Auditor Financial Analyst</h3>
        <p className="text-sm text-gray-600 mb-3 line-clamp-2 overflow-hidden text-ellipsis">Pelajari laporan keuangan dan teknik audit dari praktisi.</p>
        <div className="flex justify-between items-center mt-auto">
          <div className="flex items-center gap-2">
            <img src={avatarCBM} alt="Jenna Ortega" className="w-8 h-8 rounded-full" />
